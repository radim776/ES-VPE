namespace EventScriptIDE.Dialogs
{
	partial class InstallNetSdk
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "VBC was not detected,please install .NET sdk";
			// 
			// button1
			// 
			...
			this.button1.Text = "download .NET Sdk";
			...
			this.button2.Text = "I have installed the SDK";
			...
			this.button3.Text = "the SDK is in a diffirient place";
			...
			this.label2.Text = "VBC is required for the app to compile programs\r\nplease install it otherwise the " +
    "compile may not work";
			// 
			// InstallNetSdk
			// 
			...
			this.Name = "InstallNetSdk";
			this.Text = "InstallNetSdk";
